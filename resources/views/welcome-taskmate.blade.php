...
<body>
    ...
    <!-- Logo latar belakang -->
    <img src="{{ asset('images/logo-taskmate.png') }}" alt="TaskMate Background" class="logo-background">

    <div class="container main-content">
        <h1 class="fw-bold">Selamat Datang<br>Di<br>TaskMate</h1>

        <!-- Logo tengah -->
        <img src="{{ asset('images/logo-taskmate.png') }}" alt="TaskMate Logo" class="logo-center">
