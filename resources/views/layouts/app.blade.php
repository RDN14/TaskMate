...
<body>
    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <a class="navbar-brand d-flex align-items-center mb-0 h1" href="{{ url('/') }}">
            <img src="{{ asset('images/logo-taskmate.png') }}" alt="TaskMate Logo" style="height: 30px; margin-right: 8px;">
            <span class="fw-bold text-dark">TaskMate</span>
        </a>
        ...
        <footer class="footer mt-auto py-3 bg-dark">
            <div class="container text-center">
                <span class="text-light">© {{ date('Y') }} - To Do List. Designed by TaskMate Designer. All rights reserved.</span>
            </div>
        </footer>
    </div>
